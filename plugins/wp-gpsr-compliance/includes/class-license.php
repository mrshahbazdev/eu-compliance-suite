<?php
/**
 * License stub for EuroComply GPSR Compliance Manager.
 *
...
final class License {
	...
	public const OPTION_KEY = 'eurocomply_gpsr_license';
	...
	public static function activate( string $key ) : array {
		...
		if ( ! preg_match( '/^EC-[A-Z0-9]{6,}$/', $key ) ) {
			return array(
				'ok'      => false,
				'message' => __( 'Invalid license key format. Expected EC-XXXXXX.', 'eurocomply-gpsr' ),
			);
		}
		update_option(
			self::OPTION_KEY,
		...
		return array(
			'ok'      => true,
			'message' => __( 'License activated. Pro features are now available.', 'eurocomply-gpsr' ),
		);
	}
